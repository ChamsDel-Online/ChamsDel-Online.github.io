...
<style>
  ...
  * {
  ...
  .v0-project-featured {
    ...
    box-shadow: 0 8px 24px rgba(19, 70, 134, 0.25);
    background: linear-gradient(to bottom, var(--color-bg), var(--color-bg-alt));
    position: relative;
  }

  .v0-project-featured::before {
    content: '';
    position: absolute;
    top: 0;
    left: 0;
    right: 0;
    height: 4px;
    background: linear-gradient(90deg, var(--color-accent), rgba(19, 70, 134, 0.5));
  }

  .v0-project-featured:hover {
    border-color: var(--color-accent);
    box-shadow: 0 12px 32px rgba(19, 70, 134, 0.35);
  ...
  .v0-badge-current {
    ...
    background: linear-gradient(135deg, var(--color-accent), rgba(19, 70, 134, 0.8));
    color: white;
    border-radius: 1rem;
    font-size: 0.75rem;
    font-weight: 700;
    ...
    <div class="v0-grid">
      ...
      <div class="v0-project">
        ...
        <div class="v0-project-content">
          ...
          <p>
            ...
            <strong>Now part of TwitKit</strong> — all features have been moved to the unified platform.
          </p>
          <a href="https://twitkit.com" class="v0-project-link">
            Visit TwitKit →
          </a>
        </div>
      </div>
      ...
      <div class="v0-project v0-project-featured">
        ...
        <div class="v0-project-content">
          ...
          <h3>TwitPick</h3>
          <p>
            Smart reply prioritization for X (Twitter) powered by data. Prioritize which replies matter most and make smarter engagement decisions. Everything runs locally in your browser—no auto-posting, no backend tracking.
          </p>
          <p style="margin-top: 1rem; padding: 1rem; background: var(--color-bg-alt); border-radius: var(--border-radius); border-left: 3px solid var(--color-accent);">
            <strong>🎉 Beta Testing Available:</strong> Get 80% off and a 30-day free trial. Join now and help shape the future of TwitPick!
          </p>
          <a href="https://twitpick.com" class="v0-project-link">
            Visit Site →
          </a>
        </div>
      </div>
      ...
      <div class="v0-project">
        ...
        <div class="v0-project-content">
          ...
          <p style="margin-top: 1rem; padding: 0.75rem; background: var(--color-bg-alt); border-radius: var(--border-radius); font-size: 0.875rem; color: var(--color-text-secondary);">
            <strong>Why it was paused:</strong> High complexity of reliably finding menu items from thousands of restaurants with necessary details to add value to picky eaters and people with food allergies. Too big for a solo builder.
          </p>
        </div>
      </div>
      ...
      <div class="v0-project">
        ...
        <div class="v0-project-content">
          <div class="v0-project-tags">
            <span class="v0-project-tag">Travel & Planning</span>
            <span class="v0-project-status v0-status-killed">⚰️ Killed</span>
          </div>
          <h3>TripsToGo.ai</h3>
          <p>
            AI-Powered Group Travel Planner. The smartest way to plan group travel. Plan trips effortlessly with friends, family, or colleagues.
          </p>
          <p style="margin-top: 1rem; padding: 0.75rem; background: var(--color-bg-alt); border-radius: var(--border-radius); font-size: 0.875rem; color: var(--color-text-secondary);">
            <strong>Why it was killed:</strong> Too complex and the scope was too big for a solo builder.
          </p>
          <span class="v0-project-link" style="opacity: 0.5; cursor: not-allowed; text-decoration: line-through;">
            TripsToGo.ai
          </span>
        </div>
      </div>
...
<div class="v0-section">
  <div class="v0-container">
    <div class="v0-cta">
      <h2 id="contact">Want to Build Too?</h2>
      <p>
        If you're a parent who's ever thought "I wish I could build something" — follow along.<br>
